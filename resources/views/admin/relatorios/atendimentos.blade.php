...
@section('content')
        ...
        <form method="GET" class="mobile-filters">
            <div class="filter-row">
                <div class="filter-group">
                    ...
                    <input type="datetime-local" id="data_inicio" name="data_inicio" value="{{ $dataInicio }}"
                        class="filter-input">
                </div>

                <div class="filter-group">
                    <label for="data_fim">Data/Hora Fim:</label>
                    <input type="datetime-local" id="data_fim" name="data_fim" value="{{ $dataFim }}"
                        class="filter-input">
                </div>
            </div>
        ...
        @if ($agendamentosPorData->count() > 0)
            ...
            <div class="pagination-controls">
                <form method="GET" class="per-page-selector">
                    ...
                    <select name="per_page" id="per_page" onchange="this.form.submit()" class="filter-input"
                        style="width: auto;">
    ...
    <div
        ...
        <div class="card" style="background-color: #e8f5e9; border-left: 5px solid #4CAF50;">
            ...
            <p style="font-size: 2rem; font-weight: bold; color: #2e7d32;">R$ {{ number_format($valorGanho, 2, ',', '.') }}
            </p>
        ...
        <div class="card" style="background-color: #e3f2fd; border-left: 5px solid #2196F3;">
            ...
            <p style="font-size: 2rem; font-weight: bold; color: #1976d2;">R$
                {{ number_format($valorFuturo, 2, ',', '.') }}</p>
